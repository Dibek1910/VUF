...
class CaptainMatchesTab extends StatelessWidget {
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(
                      child: TabBarView(
                        children: [
                          _buildMatchesList(captainProvider, 'Upcoming'),
                          _buildMatchesList(captainProvider, 'Live'),
                          _buildMatchesList(captainProvider, 'Completed'),
                        ],
                      ),
                    ),
                  ],
  ...
  Widget _buildMatchesList(CaptainProvider captainProvider, String status) {
    if (captainProvider.isLoading) {
      return const Center(child: CircularProgressIndicator());
    }

    final filteredMatches = captainProvider.captainMatches
          ...
          children: [
            ...
            Text(
              match.matchDate != null
                  ? 'Date: ${match.matchDate!.day}/${match.matchDate!.month}/${match.matchDate!.year}'
                  : 'Date: TBD',
              style: const TextStyle(
                color: AppTheme.textLightColor,
              ),
